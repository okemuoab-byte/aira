...
class MongoDBIntegrationTester:
    ...
    def test_error_handling(self):
        ...
        if response["status_code"] == 401:
            ...
            self.log_test("Unauthorized Access Handling", False, "Did not handle unauthorized access properly")
    ...
    def test_family_sharing(self):
        """Test 9: Family Sharing Functionality"""
        print("🔍 Testing Family Sharing...")
        ...
        if response["success"]:
            ...
            self.log_test("Get Family Members", True, f"Retrieved family members list")
        else:
        ...
        response = self.make_request("PUT", "/family/sharing-settings", sharing_settings)
    ...
    def generate_report(self):
        ...
        with open("mongodb_integration_test_report.json", "w") as f:
            json.dump(report_data, f, indent=2, default=str)
        
        print(f"\n📄 Detailed report saved to: mongodb_integration_test_report.json")
        print("="*80)
